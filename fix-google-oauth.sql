...
-- This script improves the user profile creation and OAuth handling
...
-- 6. Ensure profiles table has all necessary columns
DO $$ 
BEGIN
...
-- 7. Update existing profiles to have default values
