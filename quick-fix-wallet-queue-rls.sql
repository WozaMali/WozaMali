-- Quick fix for wallet_update_queue RLS policy violation
...
-- Create the approve_collection function with proper error handling
...
BEGIN
  ...
  -- Compute totals from collection_materials
  SELECT 
...
-- Create the reject_collection function
