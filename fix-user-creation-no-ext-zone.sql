-- Fix User Creation Database Errors (UPDATED SCHEMA - NO ext_zone_phase)
...
-- REMOVED: ext_zone_phase references
...
BEGIN
  ...
  -- UPDATED: Removed ext_zone_phase column
  BEGIN
...
-- ✅ REMOVED: ext_zone_phase column references
...
-- ✅ FIXED: Column count mismatch in INSERT statements
