-- Create user_profiles table and complete schema
...
-- 11. Create green_scholar_fund table
...
-- 12. Insert some sample materials
...
-- 14. Enable Row Level Security (but don't create policies yet)
