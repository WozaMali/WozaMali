...
-- 3. Function to recalculate all collection totals
-- ============================================================================
...
-- 4. Create a helper function to manually recalculate a specific collection
-- ============================================================================
...
-- 5. Execute the recalculation for existing data
-- ============================================================================
...
SELECT 
    'Summary of all collections:' as info,
    COUNT(*) as total_collections,
    SUM(computed_value) as total_computed_value,
