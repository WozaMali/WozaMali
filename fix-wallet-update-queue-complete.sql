-- ============================================================================
-- FIX WALLET_UPDATE_QUEUE TABLE AND TRANSACTION HISTORY ISSUE
-- ============================================================================
-- This script fixes the 400 Bad Request error when querying wallet_update_queue
-- and ensures transaction history is properly displayed for users like legacymusicsa@gmail.com

-- 1. Create wallet_update_queue table if it doesn't exist
-- ============================================================================
...
SELECT 
    '✅ WALLET_UPDATE_QUEUE FIX COMPLETE' as status,
    'Table created with proper structure and RLS policies' as description,
