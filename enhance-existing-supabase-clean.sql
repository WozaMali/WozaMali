-- Enhance Existing Supabase Database for Live Data Access (CLEAN VERSION)
-- This script works with your existing database structure and adds live data features

-- ============================================================================
-- 1. CREATE ENHANCED LIVE WALLET DATA VIEW
-- ============================================================================

-- Drop existing view if it exists
DROP VIEW IF EXISTS live_wallet_data;

-- Create enhanced live wallet data view that works with your existing structure
...
BEGIN
    ...
    v_environmental_impact := jsonb_build_object(
        'co2_saved_kg', v_collection.weight_kg * 0.5,
        'water_saved_liters', v_collection.weight_kg * 0.1,
        'landfill_saved_kg', v_collection.weight_kg * 0.8,
        'trees_equivalent', v_collection.weight_kg * 0.1
    );
...
-- ============================================================================
-- 10. TEST THE LIVE DATA SYSTEM
-- ============================================================================

-- Test query to see live wallet data
-- SELECT * FROM live_wallet_data WHERE user_id = 'your-user-id-here';

-- Test query to see collection summary
-- SELECT * FROM collection_summary WHERE user_id = 'your-user-id-here';
