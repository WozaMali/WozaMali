-- ============================================================================
-- Corrected Soft Delete Implementation for WozaMali
-- This file implements the complete soft delete system for transactions
-- Handles cases where unified_collections table might not exist or have different structure
-- ============================================================================
...
-- Create a view that excludes deleted transactions from unified_collections (if table exists)
-- Note: This view will only work if unified_collections table exists
-- If the table doesn't exist, this view will be empty
...
-- Summary
-- ============================================================================
SELECT '✅ Corrected soft delete system implemented successfully' AS status;
