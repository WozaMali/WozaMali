-- ============================================================================
-- CORRECTED WALLET INTEGRATION - USING OFFICE APP TABLES
-- ============================================================================
-- This script uses the ACTUAL table structure from the Office App:
-- - collections (main pickup table)
-- - pickup_items (individual materials within pickups)
-- - materials (material definitions and rates)
...
-- It uses collections, pickup_items, and materials tables
