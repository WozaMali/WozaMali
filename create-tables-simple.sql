-- Create all tables except materials (simplified version)
-- Run this in your Supabase SQL Editor to create the main tables
...
CREATE TABLE IF NOT EXISTS public.pickup_items (
  ...
  material_id UUID, -- We'll reference materials table later
