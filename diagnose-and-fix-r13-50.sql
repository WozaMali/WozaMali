-- ============================================================================
-- DIAGNOSE AND FIX R13.50 PET REVENUE ISSUE
-- ============================================================================
...
-- Check collection_green_scholar_contributions table
...
WHERE green_scholar_contribution = 13.50 OR green_scholar_contribution = 13.5
ORDER BY created_at DESC;
...
UNION ALL
SELECT 
    'From collection_green_scholar_contributions' as source,
    COALESCE(SUM(green_scholar_contribution), 0) as pet_revenue
FROM collection_green_scholar_contributions;

-- Step 3: AGGRESSIVE CLEANUP - Remove ALL R13.50 related data
...
DELETE FROM collection_green_scholar_contributions 
WHERE green_scholar_contribution = 13.50 
   OR green_scholar_contribution = 13.5
   OR (green_scholar_contribution BETWEEN 13.49 AND 13.51);

SELECT 'Deleted R13.50 contributions from collection_green_scholar_contributions' as result;

-- Step 4: Reset fund balance completely
...
SELECT 
    ...
    COALESCE(SUM(green_scholar_contribution), 0) as total_contributions,
    'REMAINING CONTRIBUTIONS' as description
FROM collection_green_scholar_contributions;
